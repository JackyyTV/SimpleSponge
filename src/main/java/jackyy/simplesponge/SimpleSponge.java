...
@Mod(modid = SimpleSponge.MODID, version = SimpleSponge.VERSION, name = SimpleSponge.MODNAME, dependencies = SimpleSponge.DEPENDS, acceptedMinecraftVersions = SimpleSponge.MCVERSION, guiFactory = SimpleSponge.GUIFACTORY, certificateFingerprint = "@FINGERPRINT@", useMetadata = true)
public class SimpleSponge {
    ...
    public static final String GUIFACTORY = "jackyy.simplesponge.registry.ConfigGuiFactory";
    public static final CreativeTabs TAB = new CreativeTabs(MODID) {
        @Override
        public Item getTabIconItem() {
            return ModItems.spongeOnAStick;
        }
    };
