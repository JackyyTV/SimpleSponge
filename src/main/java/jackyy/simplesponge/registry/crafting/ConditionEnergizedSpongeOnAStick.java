...
public record ConditionEnergizedSpongeOnAStick(boolean enabled) implements ICondition {
    ...
    public boolean test(IContext context) {
        return ModConfigs.CONFIG.enableEnergizedSpongeOnAStick.get() == enabled;
    }
